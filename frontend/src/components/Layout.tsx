        ...
        <div className="p-3 flex-1 flex flex-col">
          ...
          <div className={cn(
            ...
            {!isCollapsed && (
              <div className="text-primary-foreground overflow-hidden">
                ...
                <p className="text-xs text-primary-foreground/70">{user?.role || 'Role'}</p>
              </div>
            )}
          </div>
          ...
          <div className="pt-4 border-t border-brand-blue">
            <Button
              ...
              className="w-full text-primary-foreground/70 hover:bg-red-600/20 hover:text-red-400 justify-start"
            >
