...
const Login = () => {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#6B9B7A] to-[#4A7C59]">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#6B9B7A] to-[#4A7C59] p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <Input
                ...
                disabled={loading}
                className="w-full h-11 px-4 border-gray-300 focus:border-primary focus:ring-primary"
                required
              />
            </div>
