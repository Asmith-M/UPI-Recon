...
def extract_rrn(text: str) -> Optional[str]:
    ...
    Looks for optional RRN prefix followed by 12 or more digits.
    Also extracts standalone 12+ digit numbers.

    Examples:
        "RRN 123456789012" -> "123456789012"
        "ref: 987654321098123" -> "987654321098123"
        "check 112233445566789" -> "112233445566789"
        "636397811101708" -> "636397811101708"
    ...
    """
    # Look for optional RRN/ref prefix followed by 12 or more digits
...
def validate_rrn(rrn: str) -> bool:
    """
    Validates that RRN is 12 or more digits.
